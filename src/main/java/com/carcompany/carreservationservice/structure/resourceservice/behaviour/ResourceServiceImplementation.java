...
public class ResourceServiceImplementation implements ResourceService {
	 ...
	 */
	public Resource getSelectedResource(ResourceEnumeration... resourceEnumerations) throws MoreThanOneDecoratableResourceException, NoDecoratableResourceException {
		...
		for(ResourceEnumeration resourceEnumeration : resourceEnumerations) {
			if(resourceEnumeration == ResourceEnumeration.CAR) {
				if(foundDecoratableResource == true) throw new MoreThanOneDecoratableResourceException();
				else {
		...
		if(foundDecoratableResource == false) throw new NoDecoratableResourceException();
