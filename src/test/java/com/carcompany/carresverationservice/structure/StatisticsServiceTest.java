...
class StatisticsServiceTest {
	...
	static void setUpBeforeClass() throws Exception {
		...
		statisticsService = StatisticsServiceImplementation.getInstance();
		paymentService = PaymentServiceImplementation.getInstance();
		bookingService = BookingServiceImplementation.getInstance();
		personService = PersonServiceImplementation.getInstance();
		resourceService = ResourceServiceImplementation.getInstance();
	...
	void canGermanPaymentOutOfBookingsBeGathered() {
		...
		assertEquals(1, payPal.getBookingSum());
		assertEquals(120.0, payPal.getPaymentSum());
		...
		statisticsService.getGermanBookingsPaidBy(payPal);
		assertEquals(2, payPal.getBookingSum());
		assertEquals(240.0, payPal.getPaymentSum());
	}
	...
	void canEnglishPaymentOutOfBookingsBeGathered() {
		...
		assertEquals(1, applePay.getBookingSum());
		assertEquals(120.0, applePay.getPaymentSum());
